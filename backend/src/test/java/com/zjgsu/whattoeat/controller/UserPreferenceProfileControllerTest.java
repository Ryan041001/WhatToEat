...
class UserPreferenceProfileControllerTest {
    ...
    void getPreferenceProfileShouldAggregatePreferenceSignalsFromCurrentData() throws Exception {
        ...
        createChoice(user.getId(), "B0FFPROF001", "轻食能量碗", LocalDateTime.now().minusDays(1));
        createChoice(user.getId(), "B0FFPROF002", "上周吃过的米线", LocalDateTime.now().minusDays(10));
    ...
    private void createChoice(Long userId, String poiId, String poiName, LocalDateTime chosenAt) {
