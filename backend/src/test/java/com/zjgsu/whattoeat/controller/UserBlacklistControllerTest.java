...
class UserBlacklistControllerTest {
    ...
    void addBlacklistShouldReturn201AndPersistRecord() throws Exception {
        UserEntity user = createUser("mock-openid-blacklist-001", "Alice");
    ...
    @Test
    void addBlacklistShouldReturn404WhenUserMissing() throws Exception {
    ...
    void addBlacklistShouldReturn409WhenDuplicateRecordExists() throws Exception {
        UserEntity user = createUser("mock-openid-blacklist-002", "Bob");
